// Transcrypt'ed from Python, 2024-09-14 18:37:31
...
export var Compteur =  __class__ ('Compteur', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, count) {
	...
	get decrement () {return __get__ (this, function (self) {
		self.count--;
	});},
	get reset () {return __get__ (this, function (self) {
		self.count = 0;
	});},
	get get_count () {return __get__ (this, function (self) {
		return self.count;
	});}
});

//# sourceMappingURL=compteur.map